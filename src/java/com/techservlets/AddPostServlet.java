...
//            out.println("<h1>Servlet AddPostServlet at " + request.getContextPath() + "</h1>");
            ...
            String pTitle = request.getParameter("txtmypost");
            String pContent = request.getParameter("txtpostcontent");
            String pCode = request.getParameter("txtpostprogram");
            Part part = request.getPart("mypostimage");
