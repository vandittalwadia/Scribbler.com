...
<html>
    ...
    <body style="background: url(img/regback.jpg);background-size: cover ; background-attachment: fixed;">
        <!--navbar-->
...
<!--      <li class="nav-item dropdown">
    ...
    <form class="form-inline my-2 my-lg-0">
     ...
     <div class="main">
      <div class="register">
          <font size="6" color = "#ffffff" ><center><span class="fa fa-user"></span> Blogger's Sign Up Window</center></font>
         <br>
